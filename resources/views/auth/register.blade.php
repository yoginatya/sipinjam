...
<head>
    ...
    <title>{{ __('messages.register_student') }} - {{ __('messages.SiPinjam') }}</title>
                ...
                <div class="bg-white rounded-2xl
                    ...
                    <div class="mb-7">
                        ...
                        <p class="text-gray-500 text-sm mt-2">
                            {{ __('messages.create_account_intro') }}
                        </p>
                    ...
                    <form
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('nim') }}"
                                required
                                placeholder="{{ __('messages.nim_placeholder') }}"
                                class="w-full px-4 py-3 rounded-xl
                                       border border-gray-200
                                       focus:outline-none
                                       focus:ring-2 focus:ring-blue-500/20
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('prodi') }}"
                                required
                                placeholder="{{ __('messages.study_program_placeholder') }}"
                                class="w-full px-4 py-3 rounded-xl
                                       border border-gray-200
                                       focus:outline-none
                                       focus:ring-2 focus:ring-blue-500/20
